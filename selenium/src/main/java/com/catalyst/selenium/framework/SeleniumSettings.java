...
public class SeleniumSettings {
	...
	private static String chromeDriver = "src/main/java/com/catalyst/selenium/drivers/chromedriver.exe";
	private static String ieDriver = "src/main/java/org/com/catalyst/selenium/drivers/IEDriverServer.exe";
